...
createCRUDRoutes(Meal, 'meals');
createCRUDRoutes(PhysicalActivity, 'activities');
createCRUDRoutes(SleepRecord, 'sleep');
createCRUDRoutes(WaterIntake, 'water');
createCRUDRoutes(MeditationSession, 'meditation');
